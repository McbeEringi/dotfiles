...
local drun=hl.dsp.exec_cmd(msg.."panel-open launcher")
...
hl.bind("XF86AudioMute",       hl.dsp.exec_cmd(msg.."volume-mute"),{locked=true,repeating=true})
hl.bind("XF86AudioMicMute",    hl.dsp.exec_cmd(msg.."mic-mute"),   {locked=true,repeating=true})
...
hl.bind("XF86AudioPause",hl.dsp.exec_cmd(msg.."media pause"),   {locked=true})
