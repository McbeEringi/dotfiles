...
[ $LOCALE_GEN ] || LOCALE_GEN='ja_JP.UTF-8';echo LOCALE_GEN	$LOCALE_GEN # LOCALE_GEN='en_US.UTF-8|ja_JP.UTF-8'
...
)efibootmgr edk2-shell sudo nano git openssh man-db base-devel iwd bluez bluez-utils sof-firmware kexec-tools brightnessctl
